...
;if (jQuery(window).width() < 1199) {
    ...
    jQuery('#login').removeClass('button-link');
    
};
if (jQuery(window).width() < 575) {

    jQuery('#partner').removeClass('button-link');
